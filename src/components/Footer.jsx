      ...
      <div className="max-w-[1280px] w-full px-4 md:px-8 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-sm">
            <a href="#docs" className="text-muted-text hover:text-white transition-colors">
              Docs
            </a>
          ...
          <div className="flex gap-4">
            <a href="#" className="text-muted-text hover:text-primary transition-colors">
        ...
        <div className="mt-8 text-center text-[11px] text-muted-text/80">
          © 2024 Findex Inc. All rights reserved. This is a simulated trading platform. No real money, deposits, or
